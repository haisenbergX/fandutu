...
//        		if(par.parent&&((par.parent == endPort)||(endPort.parent&&(endPort.parent == par.parent)))){
//        			
//        		}
//        		else{
            		var child = {};
...
//        		if(par.parent&&((par.parent == startPort)||(startPort.parent&&(startPort.parent == par.parent)))){
//        			
//        		}
//        		else{
        			var child = {};
